...
const {
    ...
    createAnswer, setQuestionSolved, voteQuestion, voteAnswer
...
router.post('/questions', protect, validate(schemas.createQuestion), createQuestion);
router.post('/questions/:id/answers', protect, validate(schemas.createAnswer), createAnswer);
